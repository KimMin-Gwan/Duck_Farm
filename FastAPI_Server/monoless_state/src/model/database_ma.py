...
class Local_Database: 
    ...
    def __connect_db(self):
        ...
        self.conn=pymysql.connect(host="db-l6ul6-kr.vpc-pub-cdb.ntruss.com",user="duck",password="duckfarm1234!",db='duckfarm',charset='utf8')
...
class Database:
    ...
    def __connect_db(self):
        print("reun __connect_local")
        self.conn=pymysql.connect(host="db-l6ul6-kr.vpc-pub-cdb.ntruss.com",user="root",password="duckfarm1234!",db='duckfarm',charset='utf8')
        self.cur=self.conn.cursor()      
